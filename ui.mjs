...
export {
  thead, td, copyNameText, copyButton, row, render, getStyle, list, clothesNameTd,
  clothesNameTd_Search, button_search, shoppingCartButton, removeShoppingCartButton, drawTable
};
