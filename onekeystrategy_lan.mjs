import { clothes, loadFromStorage, accSumScore, accCateNum } from './model.mjs';
...
export {
  lanStrategy_init, lanStrategy, lanStrategy_recalc, lanStrategy_print, getLazySetScore, evalSets,
  listCateName, removeFromArray, isAcc, isAcc_c, isAccSumScore, lanOwnChk, add_lanSteps,
  min_lanSteps, add_limitRet, min_limitRet, cntKeywordsReturns, pspan_id, initOnekey_lan
};
